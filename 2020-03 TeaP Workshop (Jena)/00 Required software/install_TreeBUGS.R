...
#
# For questions, please contact Daniel Heck (dheck@uni-marburg.de)
#
################################################################################
...
# 3c. Sometimes, Windows users get the following error:
...
#    2. Type/search for "edit the system environment variables"
...
#        "MCMC sampling started at  2019-05-......"
